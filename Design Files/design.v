...
<div class="g-recaptcha" data-sitekey="6LfVlhoqAAAAAJPphpDvPwn3NPaFdCGm5GB1QCfr" data-action="Login"></div>
                        ...
                        <input type="hidden" name="_csrf"
                               value="c7d83d38-123a-46b4-99dc-40d9a9a93326" />
...
<title>UVM FINAL PROJECT - EDA Playground</title>
...
<!-- Hidden fields -->
    <form style="display:none;">
        ...
        <input id="codeUserId" type="hidden" value="757867"/>
        <input id="sessionUserId" class="ignoreTogetherJS" type="hidden" value="757867"/>
        <input id="codeSimulatorText" type="hidden" value="Riviera Pro 2023.04"/>
        <input id="codeSimulatorNotAvailable" type="hidden"/>
    </form>
    <form style="display:none;" id="codeForm" action="#" method="post">
        <input id="codeId" name="id" type="hidden" value="5852899"/>
        <input id="codeName" name="name" type="hidden"/>
        <input id="codeDescription" name="description" type="hidden"/>
        <input id="codeLink" name="link" type="hidden" value="5852899"/>
        ...
        <input id="codeSimulatorId" name="simulatorId" type="hidden" value="1204"/>
        <input id="numberOfViews" name="numberOfViews" type="hidden" value="0"/>
        <input id="numberOfLikes" name="numberOfLikes" type="hidden" value="0"/>
        <input id="expertMode" name="expertMode" type="hidden" value="false"/>
        <input id="_csrfToken" name="_csrf" value="c7d83d38-123a-46b4-99dc-40d9a9a93326" class="ignoreTogetherJS _csrfToken" type="hidden"/>
        </form>
    <form style="display:none" id="launchEpwaveForm" action="/launchEpwave" method="post" target="_blank">
        ...
        <input name="_csrf" value="c7d83d38-123a-46b4-99dc-40d9a9a93326" class="ignoreTogetherJS _csrfToken" type="hidden"/>
    </form>
...
<a href="https://www.doulos.com/events/webinars/formal-verification-for-non-specialists/?source=edap" target="_blank">
                                    <img style="height: 40px; width: 536px; object-fit: contain;" src="https://www.doulos.com/media/e0jhj2bx/eda-playground-advert_form4ns_0625.jpg"></a>
                                </a>
</div>
                    <div class="mySlides">
                            <div class="numbertext">2 / 3</div>
<a href="https://www.doulos.com/events/workshops/unveiling-the-amd-versal-adaptive-soc-ai-engine-workshop/" target="_blank">
                                    <img style="height: 40px; width: 536px; object-fit: contain;" src="https://www.doulos.com/media/33qjg02z/eda-playground-ad_workshop_amdjun25.jpg"></a>
                                </a>
</div>
                    <div class="mySlides">
                            <div class="numbertext">3 / 3</div>
<a href="https://www.doulos.com/events/workshops/essential-systemverilog-assertions-workshop/" target="_blank">
                                    <img style="height: 40px; width: 536px; object-fit: contain;" src="https://www.doulos.com/media/bdoixhgf/eda_ad_svaworkshop.jpg"></a>
                                </a>
</div>
            ...
            <li class="dropdown">
                ...
                <li class="dropdown">
                            <a id="playgroundsDropdown" onclick="sendGA('home', 'home_playgrounds_dropdown');" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-rocket"></i>&nbsp; Playgrounds
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a id="user-playgrounds-btn" onclick="sendGA('home', 'home_playgrounds_user');" href="/playgrounds/user/757867">Your Playgrounds</a></li>
                                <li><a onclick="sendGA('home', 'home_playgrounds_published');" href="/playgrounds">Published Playgrounds</a></li>
                                </ul>
                        </li>

                        <li class="dropdown">
                            <a id="profileDropdown" onclick="sendGA('home', 'home_profile_dropdown');" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-user-circle"></i>&nbsp; Profile
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li id="user-page-btn"><a onclick="sendGA('home', 'home_user_page');" href="/user/757867">Profile</a></li>
                                <li id="btn-logout"><a onclick="sendGA('home', 'home_user_page_logout');" href="/user/757867#logout">Logout</a></li>
                            </ul>
                        </li>
...
<div class="row" id="left-hand-menu">
            <div class="sectionTitle col-md-12 sectionExpandable" data-title="LanguagesLibraries" id="languageLibrariesSection">
              <h4 class="unselectable">
                <i class="fa fa-caret-right sectionCaret"></i>
                  
                &nbsp;Languages & Libraries
              </h4>
            </div>
            <div id="testBenchAndDesign" class="col-md-12" style="display:none" >
        ...
        <div id="testbenchTabsButtons" class="tab-buttons">
          <ul>
              <li><a href="#testbench0">testbench.sv</a></li>
                      <li><a href="#testbench1">router_if.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench2">router_transaction.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench3">router_sequence.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench4">router_sequencer.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench5">router_driver.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench6">router_monitor.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench7">router_scoreboard.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench8">router_agent.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench9">router_env.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                      <li><a href="#testbench10">router_test.sv</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
            ...
            <div id="designTabsButtons" class="tab-buttons">
                <ul>
                    <li><a href="#design0">design.sv</a></li>
                            <li><a href="#design1">router_fifo.v</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                            <li><a href="#design2">router_fsm.v</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                            <li><a href="#design3">router_sync.v</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
                            <li><a href="#design4">router_reg.v</a><span class='ui-icon ui-icon-close' role='presentation'>Remove Tab</span></li>
        ...
        <div id="designTabsPanels" >
            <div id="designCodeId" class="tab-panels code-panel" >
                <div id="design0" class="tab-panel tab-counter"></div>
                        <div id="design1" class="tab-panel tab-counter"></div>
                        <span id="designPreviewButton1" class="pane_button designPreviewButton" style="display: none" onclick="showPreview('design1')">Show Preview</span>
                        <div id="design2" class="tab-panel tab-counter"></div>
                        <span id="designPreviewButton2" class="pane_button designPreviewButton" style="display: none" onclick="showPreview('design2')">Show Preview</span>
                        <div id="design3" class="tab-panel tab-counter"></div>
                        <span id="designPreviewButton3" class="pane_button designPreviewButton" style="display: none" onclick="showPreview('design3')">Show Preview</span>
                        <div id="design4" class="tab-panel tab-counter"></div>
                        <span id="designPreviewButton4" class="pane_button designPreviewButton" style="display: none" onclick="showPreview('design4')">Show Preview</span>
                        </div>
          ...
          <form id="detailsForm" style="height: calc(100% - 50px); margin-bottom: 29px;">
              ...
              <div style="margin-bottom: 5px;">
                  ...
                  <span>
                              ...
                              <input style="width: 300px; margin-left: 7px; margin-right: 7px;" id="name" class="bottom-section-text" type="text" placeholder="Add a title to help you find your playground" title="Name" value="UVM FINAL PROJECT" maxlength="50">
                          
                      
                    </span>
                  
                      <span>
                          <span id="numberViews" style="font-weight: bold">0</span> views
        ...
        <div class="modal-body">
            <form>
                ...
                <div class="col-md-12" style="padding: 0px 0px 15px">
                  <input id="shareLink" class="form-control" type="text" value="http://www.edaplayground.com/x/wuW5"/>
                </div>
            </form>
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="col-md-8" style="padding: 0px 0px 15px">
                <div id="labName">UVM FINAL PROJECT</div>
            </div>
            <label>Link</label>
            <div class="col-md-8" style="padding: 0px 0px 15px">
            <div id="submitLinkDiv">http://www.edaplayground.com/x/wuW5</div>
            <input id="submitLink" type="hidden" value="http://www.edaplayground.com/x/wuW5" />
            </div>
          </form>
        </div>
        <div class="modal-footer">
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/simplemde/latest/simplemde.min.css">
   ...
   var togetherJsMessageReceived =  function (msg) {
     ...
     window.addEventListener("focus", function(event)
        {
           document.title="UVM FINAL PROJECT - EDA Playground";
        }, false);
   ...
   var togetherJsMessageReceived =  function (msg) {
    ...
    var TogetherJSConfig_toolName = 'Collaboration',
        ...
        TogetherJSConfig_getUserName = function(){return 'trainee3 student3'; },
...
//        TogetherJSConfig_suppressInvite = true,
    ...
    // Globals
      ...
      QUESTA_RUN =
        false,
      contextPath = "",
      remoteUser = "vlsisystem3@ibisacademy.yaconnect.com",
      userId = "757867",
      isAdmin = "false",
          expertMode = "false",
      ...
      USER_CAN_USE_VALIDATED_SIMULATORS = true,
    ...
    var codeFiles = [{"name":"router_fifo.v","id":241667870,"type":"DESIGN","contents":"module router_fifo(clk,resetn,soft_reset,write_enb,read_enb,lfd_state,datain,full,empty,dataout);\\r\\n\\/\\/INPUT,OUTPUT\\r\\ninput clk,resetn,soft_reset,write_enb,read_enb,lfd_state;\\r\\ninput [7:0]datain;\\r\\noutput reg full,empty;\\r\\noutput reg [7:0]dataout;\\r\\n\\/\\/internal Data types\\r\\nreg [3:0]read_ptr,write_ptr;\\r\\nreg [5:0]count;\\r\\nreg [8:0]fifo[15:0];\\/\\/9 BIT DATA WIDTH 1 BIT EXTRA FOR HEADER AND 16 DEPTH SIZE\\r\\ninteger i;\\r\\nreg temp;\\r\\nreg [4:0] incrementer;\\r\\n\\r\\n\\/\\/------------------------------------------------------------------------------\\r\\n\\/\\/lfd_state\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\ttemp<=1\\'b0;\\r\\n\\t\\telse \\r\\n\\t\\t\\ttemp<=lfd_state;\\r\\n\\tend \\r\\n\\r\\n\\r\\n\\/\\/-------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/Incrementer\\r\\n\\r\\nalways @(posedge clk )\\r\\nbegin\\r\\n   if( !resetn )\\r\\n       incrementer <= 0;\\r\\n\\r\\n   else if( (!full && write_enb) && ( !empty && read_enb ) )\\r\\n          incrementer<= incrementer;\\r\\n\\r\\n   else if( !full && write_enb )\\r\\n          incrementer <=    incrementer + 1;\\t\\t\\t\\t\\t\\/\\/inc is increased because data is written\\r\\n\\r\\n   else if( !empty && read_enb )\\t\\t\\t\\t\\t\\t\\t\\t\\t\\/\\/ inc is decrease because data is read\\r\\n          incrementer <=    incrementer - 1;\\r\\n   else\\r\\n         incrementer <=    incrementer;\\r\\nend\\r\\n\\r\\n\\/\\/full and empty logic\\r\\nalways @(incrementer)\\r\\nbegin\\r\\nif(incrementer==0)      \\/\\/nothing in fifo\\r\\n  empty = 1 ;\\r\\n  else\\r\\n  empty = 0;\\r\\n\\r\\n  if(incrementer==4\\'b1111)  \\/\\/ fifo is full\\r\\n   full = 1;\\r\\n   else\\r\\n   full = 0;\\r\\nend \\r\\n\\/\\/-----------------------------------------------------------------------------------------------------\\r\\n\\r\\n\\/\\/------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/Fifo write logic\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn || soft_reset)\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tfor(i=0;i<16;i=i+1)\\r\\n\\t\\t\\t\\t\\tfifo[i]<=0; \\r\\n\\t\\t\\tend\\r\\n\\t\\t\\r\\n\\t\\telse if(write_enb && !full)\\r\\n\\t\\t\\t\\t{fifo[write_ptr[3:0]][8],fifo[write_ptr[3:0]][7:0]}<={temp,datain}; \\/\\/temp=1 for header data and 0 for other data\\r\\n\\t\\r\\n\\tend\\r\\n\\r\\n\\/\\/\\r\\n\\/\\/----------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/FIFO READ logic\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tdataout<=8\\'d0;\\r\\n\\r\\n\\t\\telse if(soft_reset)\\r\\n\\t\\t\\tdataout<=8\\'bzz;\\r\\n\\t\\t\\r\\n\\t\\telse\\r\\n\\t\\t\\tbegin \\r\\n\\t\\t\\t\\tif(read_enb && !empty)\\r\\n\\t\\t\\t\\t\\tdataout<=fifo[read_ptr[3:0]];\\r\\n\\t\\t\\t\\tif(count==0) \\/\\/ COMPLETELY READ\\r\\n\\t\\t\\t\\t\\tdataout<=8\\'bz;\\r\\n\\t\\t\\tend\\r\\n\\tend\\r\\n\\/\\/------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/counter logic\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\t\\r\\n\\t\\t if(read_enb && !empty)\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(fifo[read_ptr[3:0]][8])                          \\/\\/a header byte is read, an internal counter is loaded with the payload\\r\\n                                                               \\/\\/length of the packet plus(parity byte) and starts decrementing every clock till it reached \\r\\n\\t\\t\\t\\t\\tcount<=fifo[read_ptr[3:0]][7:2]+1\\'b1;\\r\\n\\r\\n\\t\\t\\t\\telse if(count!=6\\'d0)\\r\\n\\t\\t\\t\\t\\tcount<=count-1\\'b1;\\r\\n\\t\\t\\t\\t\\r\\n\\t\\t\\tend\\r\\n\\t\\r\\n\\tend\\r\\n\\/\\/---------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/pointer logic\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn || soft_reset)\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tread_ptr=5\\'d0;\\r\\n\\t\\t\\t\\twrite_ptr=5\\'d0;\\r\\n\\t\\t\\tend\\r\\n\\r\\n\\t\\telse \\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(write_enb && !full)\\r\\n\\t\\t\\t\\t\\twrite_ptr=write_ptr+1\\'b1;\\r\\n\\r\\n\\t\\t\\t\\tif(read_enb && !empty)\\r\\n\\t\\t\\t\\t\\tread_ptr=read_ptr+1\\'b1;\\r\\n\\t\\t\\tend\\r\\n\\tend\\r\\n\\r\\nendmodule","count":0,"parent":null,"isDirectory":0}, {"name":"router_fsm.v","id":241667871,"type":"DESIGN","contents":"module router_fsm(input clk,resetn,packet_valid,\\r\\n\\t\\t\\t\\t  input [1:0] datain,\\r\\n\\t\\t\\t\\t  input fifo_full,fifo_empty_0,fifo_empty_1,fifo_empty_2,soft_reset_0,soft_reset_1,soft_reset_2,parity_done, low_packet_valid, \\r\\n\\t\\t\\t\\t  output write_enb_reg,detect_add,ld_state,laf_state,lfd_state,full_state,rst_int_reg,busy);\\r\\n\\t\\t\\t\\t  \\r\\n parameter  decode_address\\t\\t=\\t4\\'b0001,\\r\\n\\t\\t\\twait_till_empty\\t\\t=\\t4\\'b0010,\\r\\n\\t\\t\\tload_first_data\\t\\t=\\t4\\'b0011,\\r\\n\\t\\t\\tload_data\\t\\t\\t=\\t4\\'b0100,\\r\\n\\t\\t\\tload_parity\\t\\t\\t=\\t4\\'b0101,\\r\\n\\t\\t\\tfifo_full_state\\t\\t=\\t4\\'b0110,\\r\\n\\t\\t\\tload_after_full\\t\\t=\\t4\\'b0111,\\r\\n\\t\\t\\tcheck_parity_error\\t=\\t4\\'b1000;\\r\\n\\t\\t\\t\\r\\nreg [3:0] present_state, next_state;\\r\\nreg [1:0] temp;\\r\\n\\/\\/-------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/temp logic\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(~resetn)\\r\\n\\t\\t\\ttemp<=2\\'b0;\\r\\n\\t\\telse if(detect_add)          \\/\\/ decides the address of out channel\\r\\n\\t\\t \\ttemp<=datain;\\r\\n\\tend\\r\\n\\/\\/--------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/ reset logic for states\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\t\\tpresent_state<=decode_address;  \\/\\/ hard reset\\r\\n\\t\\telse if (((soft_reset_0) && (temp==2\\'b00)) || ((soft_reset_1) && (temp==2\\'b01)) || ((soft_reset_2) && (temp==2\\'b10)))\\t\\t\\/\\/if there is soft_reset and also using same channel so we do here and opertion\\r\\n\\t\\t\\t\\t \\r\\n\\t\\t\\t\\tpresent_state<=decode_address;\\r\\n\\r\\n\\t\\telse\\r\\n\\t\\t\\t\\tpresent_state<=next_state;\\r\\n\\t\\t\\t\\r\\n\\tend\\r\\n\\/\\/-------------------------------------------------------------------------------------------------------------------------------------------\\t\\r\\n\\/\\/state machine logic \\r\\n\\r\\nalways@(*)\\r\\n\\tbegin\\r\\n\\t\\tcase(present_state)\\r\\n\\t\\tdecode_address:   \\/\\/ decode address state \\r\\n\\t\\tbegin\\r\\n\\t\\t\\tif((packet_valid && (datain==2\\'b00) && fifo_empty_0)|| (packet_valid && (datain==2\\'b01) && fifo_empty_1)|| (packet_valid && (datain==2\\'b10) && fifo_empty_2))\\r\\n\\r\\n\\t\\t\\t\\t\\tnext_state<=load_first_data;   \\/\\/lfd_state\\r\\n\\r\\n\\t\\t\\telse if((packet_valid && (datain==2\\'b00) && !fifo_empty_0)||(packet_valid && (datain==2\\'b01) && !fifo_empty_1)||(packet_valid && (datain==2\\'b10) && !fifo_empty_2))\\r\\n\\t\\t\\t\\t\\tnext_state<=wait_till_empty;  \\/\\/wait till empty state\\r\\n\\t\\t\\t\\t\\r\\n\\t\\t\\telse \\r\\n\\t\\t\\t\\tnext_state<=decode_address;\\t   \\/\\/ same state\\r\\n\\t\\tend\\r\\n\\/\\/------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\t\\tload_first_data: \\t\\t\\t\\/\\/ load first data state\\r\\n\\t\\tbegin\\t\\r\\n\\t\\t\\tnext_state<=load_data;\\r\\n\\t\\tend\\r\\n\\/\\/-----------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\t\\twait_till_empty:          \\/\\/wait till empty state\\r\\n\\t\\tbegin\\r\\n\\t\\t\\tif((fifo_empty_0 && (temp==2\\'b00))||(fifo_empty_1 && (temp==2\\'b01))||(fifo_empty_2 && (temp==2\\'b10))) \\/\\/fifo is empty and were using same fifo\\r\\n\\t\\t\\t\\t\\tnext_state<=load_first_data;\\r\\n\\t\\r\\n\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\tnext_state<=wait_till_empty;\\r\\n\\t\\t\\tend\\r\\n\\/\\/-----------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\t\\tload_data:                        \\/\\/load data\\r\\n\\t\\tbegin\\r\\n\\t\\t\\tif(fifo_full==1\\'b1) \\r\\n\\t\\t\\t\\t\\tnext_state<=fifo_full_state;\\r\\n\\t\\t\\telse \\r\\n\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\tif (!fifo_full && !packet_valid)\\r\\n\\t\\t\\t\\t\\t\\t\\tnext_state<=load_parity;\\r\\n\\t\\t\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\t\\t\\tnext_state<=load_data;\\r\\n\\t\\t\\t\\t\\tend\\r\\n\\t\\tend\\r\\n\\/\\/--------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\t\\t\\tfifo_full_state:\\t\\t\\t\\/\\/fifo full state\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(fifo_full==0)\\r\\n\\t\\t\\t\\t\\tnext_state<=load_after_full;\\r\\n\\t\\t\\t\\telse \\r\\n\\t\\t\\t\\t\\tnext_state<=fifo_full_state;\\r\\n\\t\\t\\tend\\r\\n\\/\\/-------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\t\\t\\tload_after_full:         \\t\\/\\/ load after full state\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(!parity_done && low_packet_valid)\\r\\n\\t\\t\\t\\t\\tnext_state<=load_parity;\\r\\n\\t\\t\\t\\telse if(!parity_done && !low_packet_valid)\\r\\n\\t\\t\\t\\t\\tnext_state<=load_data;\\r\\n\\t\\r\\n\\t\\t\\t\\telse \\r\\n\\t\\t\\t\\t\\tbegin \\r\\n\\t\\t\\t\\t\\t\\tif(parity_done==1\\'b1)\\r\\n\\t\\t\\t\\t\\t\\t\\tnext_state<=decode_address;\\r\\n\\t\\t\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\t\\t\\tnext_state<=load_after_full;\\r\\n\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\t\\r\\n\\t\\t\\tend\\r\\n\\/\\/-------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\t\\t\\tload_parity:                 \\/\\/ load parity state\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tnext_state<=check_parity_error;\\r\\n\\t\\t\\tend\\r\\n\\/\\/-------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\t\\t\\tcheck_parity_error:\\t\\t\\t\\/\\/ check parity error\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(!fifo_full)\\r\\n\\t\\t\\t\\t\\tnext_state<=decode_address;\\r\\n\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\tnext_state<=fifo_full_state;\\r\\n\\t\\t\\tend\\r\\n\\/\\/--------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\t\\t\\tdefault:\\t\\t\\t\\t\\t\\/\\/default state\\r\\n\\t\\t\\t\\tnext_state<=decode_address; \\r\\n\\r\\n\\t\\tendcase\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\/\\/ state machine completed\\r\\n\\tend\\r\\n\\/\\/----------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/ output logic\\r\\n\\r\\n\\r\\nassign busy=((present_state==load_first_data)||(present_state==load_parity)||(present_state==fifo_full_state)||(present_state==load_after_full)||(present_state==wait_till_empty)||(present_state==check_parity_error))?1:0;\\r\\nassign detect_add=((present_state==decode_address))?1:0;\\r\\nassign lfd_state=((present_state==load_first_data))?1:0;\\r\\nassign ld_state=((present_state==load_data))?1:0;\\r\\nassign write_enb_reg=((present_state==load_data)||(present_state==load_after_full)||(present_state==load_parity))?1:0;\\r\\nassign full_state=((present_state==fifo_full_state))?1:0;\\r\\nassign laf_state=((present_state==load_after_full))?1:0;\\r\\nassign rst_int_reg=((present_state==check_parity_error))?1:0;\\r\\n\\r\\nendmodule","count":1,"parent":null,"isDirectory":0}, {"name":"router_sync.v","id":241667872,"type":"DESIGN","contents":"module router_sync( input clk,resetn,detect_add,write_enb_reg,read_enb_0,read_enb_1,read_enb_2,empty_0,empty_1,empty_2,full_0,full_1,full_2, \\r\\n\\t\\t\\t\\t\\tinput [1:0]datain,\\r\\n\\t\\t\\t\\t\\toutput wire vld_out_0,vld_out_1,vld_out_2,\\r\\n\\t\\t\\t\\t\\toutput reg [2:0]write_enb, \\r\\n\\t\\t\\t\\t\\toutput reg fifo_full, soft_reset_0,soft_reset_1,soft_reset_2);\\r\\n\\t\\t\\t\\t\\t\\r\\nreg [1:0]temp;\\r\\nreg [4:0]count0,count1,count2;\\r\\n\\r\\n\\/\\/------------------------------------------------------------------------------------------------------------------------------------------------\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\ttemp <= 2\\'d0;\\r\\n\\t\\telse if(detect_add)\\r\\n\\t\\t\\ttemp<=datain;\\r\\n\\tend\\r\\n\\t\\r\\n\\/\\/----------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/for fifo full\\r\\nalways@(*)\\r\\n\\tbegin\\r\\n\\t\\tcase(temp)\\r\\n\\t\\t\\t2\\'b00: fifo_full=full_0;                \\/\\/ fifo fifo_full takes the value of full of fifo_0\\r\\n\\t\\t\\t2\\'b01: fifo_full=full_1;                \\/\\/ fifo fifo_full takes the value of full of fifo_1\\r\\n\\t\\t\\t2\\'b10: fifo_full=full_2;\\t\\t\\t\\t\\/\\/ fifo fifo_full takes the value of full of fifo_2\\r\\n\\t\\t\\tdefault fifo_full=0;\\r\\n\\t\\tendcase\\r\\n\\tend\\r\\n\\/\\/------------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/write enable\\r\\nalways@(*)\\r\\n\\tbegin \\r\\n\\t\\t\\t\\tif(write_enb_reg)\\r\\n\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\tcase(temp)\\r\\n\\t\\t\\t\\t\\t\\t2\\'b00: write_enb=3\\'b001;\\t\\t\\t\\t\\r\\n\\t\\t\\t\\t\\t\\t2\\'b01: write_enb=3\\'b010;\\r\\n\\t\\t\\t\\t\\t\\t2\\'b10: write_enb=3\\'b100;\\r\\n\\t\\t\\t\\t\\t\\tdefault: write_enb=3\\'b000;\\r\\n\\t\\t\\t\\t\\tendcase\\r\\n\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\twrite_enb = 3\\'b000;\\t\\t\\r\\n\\tend\\r\\n\\/\\/------------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\r\\n\\/\\/valid out\\r\\nassign vld_out_0 = !empty_0;\\r\\nassign vld_out_1 = !empty_1;\\r\\nassign vld_out_2 = !empty_2;\\r\\n\\/\\/--------------------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/soft reset counter \\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tcount0<=5\\'b0;\\r\\n\\t\\telse if(vld_out_0)\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(!read_enb_0)\\r\\n\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\tif(count0==5\\'b11110)\\t\\r\\n\\t\\t\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tsoft_reset_0<=1\\'b1;\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tcount0<=1\\'b0;\\r\\n\\t\\t\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tcount0<=count0+1\\'b1;\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tsoft_reset_0<=1\\'b0;\\r\\n\\t\\t\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\telse count0<=5\\'d0;\\r\\n\\t\\t\\tend\\r\\n\\t\\telse count0<=5\\'d0;\\r\\n\\tend\\r\\n\\t\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tcount1<=5\\'b0;\\r\\n\\t\\telse if(vld_out_1)\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(!read_enb_1)\\r\\n\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\tif(count1==5\\'b11110)\\t\\r\\n\\t\\t\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tsoft_reset_1<=1\\'b1;\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tcount1<=1\\'b0;\\r\\n\\t\\t\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tcount1<=count1+1\\'b1;\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tsoft_reset_1<=1\\'b0;\\r\\n\\t\\t\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\telse count1<=5\\'d0;\\r\\n\\t\\t\\tend\\r\\n\\t\\telse count1<=5\\'d0;\\r\\n\\tend\\r\\n\\t\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tcount2<=5\\'b0;\\r\\n\\t\\telse if(vld_out_2)\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(!read_enb_2)\\r\\n\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\tif(count2==5\\'b11110)\\t\\r\\n\\t\\t\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tsoft_reset_2<=1\\'b1;\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tcount2<=1\\'b0;\\r\\n\\t\\t\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tcount2<=count2+1\\'b1;\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tsoft_reset_2<=1\\'b0;\\r\\n\\t\\t\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\t\\telse count2<=5\\'d0;\\r\\n\\t\\t\\tend\\r\\n\\t\\telse count2<=5\\'d0;\\r\\n\\tend\\r\\n\\t\\r\\n\\t\\r\\nendmodule","count":2,"parent":null,"isDirectory":0}, {"name":"router_reg.v","id":241667873,"type":"DESIGN","contents":"module router_reg(input clk,resetn,packet_valid,\\r\\n\\t\\t\\t\\t  input [7:0] datain,\\r\\n\\t\\t\\t\\t  input fifo_full,detect_add,ld_state,laf_state,full_state,lfd_state,rst_int_reg,\\r\\n\\t\\t\\t\\t  output reg err,parity_done,low_packet_valid,\\r\\n\\t\\t\\t\\t  output reg [7:0] dout);\\r\\n\\t\\t\\t\\t  \\r\\nreg [7:0] hold_header_byte,fifo_full_state_byte,internal_parity,packet_parity_byte;\\r\\n\\/\\/--------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/parity done\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tparity_done<=1\\'b0;\\r\\n\\t\\t\\tend\\r\\n\\t\\r\\n\\t\\telse \\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(ld_state && !fifo_full && !packet_valid)\\r\\n\\t\\t\\t\\t\\t\\tparity_done<=1\\'b1;\\r\\n\\t\\t\\t\\telse if(laf_state && low_packet_valid && !parity_done)\\r\\n\\t\\t\\t\\t\\t\\tparity_done<=1\\'b1;\\r\\n\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\t\\tif(detect_add)\\r\\n\\t\\t\\t\\t\\t\\t\\tparity_done<=1\\'b0;\\r\\n\\t\\t\\t\\t\\tend\\r\\n\\t\\t\\tend\\r\\n\\tend\\r\\n\\/\\/--------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/low_packet valid\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tlow_packet_valid<=1\\'b0;\\r\\n\\t\\telse \\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(rst_int_reg)\\r\\n\\t\\t\\t\\t\\tlow_packet_valid<=1\\'b0;\\r\\n\\t\\t\\t\\tif(ld_state==1\\'b1 && packet_valid==1\\'b0)\\r\\n\\t\\t\\t\\t\\tlow_packet_valid<=1\\'b1;\\r\\n\\t\\t\\tend\\r\\n\\tend\\r\\n\\/\\/----------------------------------------------------------------------------------------------------------\\r\\n\\/\\/dout\\r\\nalways@(posedge clk)\\r\\n\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tdout<=8\\'b0;\\r\\n\\t\\telse\\r\\n\\t\\tbegin\\r\\n\\t\\t\\tif(detect_add && packet_valid)\\r\\n\\t\\t\\t\\thold_header_byte<=datain;\\r\\n\\t\\t\\telse if(lfd_state)\\r\\n\\t\\t\\t\\tdout<=hold_header_byte;\\r\\n\\t\\t\\telse if(ld_state && !fifo_full)\\r\\n\\t\\t\\t\\tdout<=datain;\\r\\n\\t\\t\\telse if(ld_state && fifo_full)\\r\\n\\t\\t\\t\\tfifo_full_state_byte<=datain;\\r\\n\\t\\t\\telse \\r\\n\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\tif(laf_state)\\r\\n\\t\\t\\t\\t\\t\\tdout<=fifo_full_state_byte;\\r\\n\\t\\t\\t\\tend\\r\\n\\t\\tend\\r\\n\\tend\\r\\n\\/\\/-----------------------------------------------------------------------------------------------------\\r\\n\\/\\/ internal parity\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tinternal_parity<=8\\'b0;\\r\\n\\t\\telse if(lfd_state)\\r\\n\\t\\t\\tinternal_parity<=internal_parity ^ hold_header_byte;\\r\\n\\t\\telse if(ld_state && packet_valid && !full_state)\\r\\n\\t\\t\\tinternal_parity<=internal_parity ^ datain;\\r\\n\\t\\telse \\r\\n\\t\\t\\tbegin\\t\\r\\n\\t\\t\\t\\tif (detect_add)\\r\\n\\t\\t\\t\\t\\tinternal_parity<=8\\'b0;\\r\\n\\t\\t\\tend\\r\\n\\tend\\r\\n\\/\\/--------------------------------------------------------------------------------------------------------\\t\\r\\n\\/\\/error and packet_\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\tpacket_parity_byte<=8\\'b0;\\r\\n\\t\\telse \\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(!packet_valid && ld_state)\\r\\n\\t\\t\\t\\t\\tpacket_parity_byte<=datain;\\r\\n\\t\\t\\tend\\r\\n\\tend\\r\\n\\/\\/-------------------------------------------------------------------------------------------------------------------------------------\\r\\n\\/\\/error\\r\\nalways@(posedge clk)\\r\\n\\tbegin\\r\\n\\t\\tif(!resetn)\\r\\n\\t\\t\\terr<=1\\'b0;\\r\\n\\t\\telse \\r\\n\\t\\t\\tbegin\\r\\n\\t\\t\\t\\tif(parity_done)\\r\\n\\t\\t\\t\\tbegin\\r\\n\\t\\t\\t\\t\\tif(internal_parity!=packet_parity_byte)\\r\\n\\t\\t\\t\\t\\t\\terr<=1\\'b1;\\r\\n\\t\\t\\t\\t\\telse\\r\\n\\t\\t\\t\\t\\t\\terr<=1\\'b0;\\r\\n\\t\\t\\t\\tend\\r\\n\\t\\t\\tend\\r\\n\\tend\\r\\n\\r\\nendmodule ","count":3,"parent":null,"isDirectory":0}, {"name":"router_if.sv","id":241667874,"type":"TESTBENCH","contents":"interface router_if(input logic clk);\\r\\n  logic resetn;\\r\\n  logic read_enb_0, read_enb_1, read_enb_2;\\r\\n  logic packet_valid;\\r\\n  logic [7:0] datain;\\r\\n  logic [7:0] data_out_0, data_out_1, data_out_2;\\r\\n  logic vldout_0, vldout_1, vldout_2;\\r\\n  logic err, busy;\\r\\n  logic detect_add,lfd_state,ld_state;\\r\\nendinterface\\r\\n","count":4,"parent":null,"isDirectory":0}, {"name":"router_transaction.sv","id":241667875,"type":"TESTBENCH","contents":"class router_transaction extends uvm_sequence_item;\\r\\n  rand bit [7:0] header;\\r\\n  rand bit [7:0] payload[];\\r\\n  bit[7:0] payload_data;\\r\\n  rand bit[5:0] payload_length;\\r\\n  bit [7:0] parity;\\r\\n  rand bit [1:0] addr;\\r\\n\\r\\n  `uvm_object_utils(router_transaction)\\r\\n\\r\\n  function new(string name=\\\"router_transaction\\\");\\r\\n    super.new(name);\\r\\n  endfunction\\r\\n\\r\\n  function void compute_parity();\\r\\n    parity = header;\\r\\n    foreach(payload[i]) parity ^= payload[i];\\r\\n  endfunction\\r\\n  \\r\\n  constraint addr_c {addr < 3;}\\r\\n  constraint payload_length_c {payload_length < 9;payload_length > 5;}\\r\\nendclass\\r\\n","count":5,"parent":null,"isDirectory":0}, {"name":"router_sequence.sv","id":241667876,"type":"TESTBENCH","contents":"class router_sequence extends uvm_sequence#(router_transaction);\\r\\n  router_transaction txn;\\r\\n  `uvm_object_utils(router_sequence)\\r\\n  \\/\\/virtual router_if  vif;\\r\\n  \\r\\n  function new(string name=\\\"router_sequence\\\");\\r\\n    super.new(name);\\r\\n  endfunction\\r\\n  \\r\\n\\r\\n  \\r\\n  virtual task body();\\r\\n    repeat (2) begin\\r\\n      txn = router_transaction::type_id::create(\\\"txn\\\");\\r\\n      assert(txn.randomize());\\r\\n      txn.compute_parity();\\r\\n      start_item(txn);\\r\\n      finish_item(txn);\\r\\n\\t  \\/\\/`uvm_do(txn);\\r\\n      \\/\\/ Small pause\\r\\n     \\/\\/repeat(5) @(posedge vif.clk);\\r\\n    end\\r\\n  endtask\\r\\nendclass\\r\\n","count":6,"parent":null,"isDirectory":0}, {"name":"router_sequencer.sv","id":241667877,"type":"TESTBENCH","contents":"class router_sequencer extends uvm_sequencer #(router_transaction);\\r\\n  `uvm_component_utils(router_sequencer)\\r\\n\\r\\n  virtual router_if vif;\\r\\n\\r\\n  function new(string name = \\\"router_sequencer\\\", uvm_component parent);\\r\\n    super.new(name, parent);\\r\\n  endfunction\\r\\n  \\r\\n  function void build_phase(uvm_phase phase);\\r\\n    super.build_phase(phase);\\r\\n  endfunction\\r\\n  \\r\\nendclass\\r\\n","count":7,"parent":null,"isDirectory":0}, {"name":"router_driver.sv","id":241667878,"type":"TESTBENCH","contents":"class router_driver extends uvm_driver#(router_transaction);\\r\\n  virtual router_if vif;\\r\\n\\r\\n  integer i;\\r\\n  \\r\\n  `uvm_component_utils(router_driver)\\r\\n\\r\\n  function new(string name = \\\"router_driver\\\", uvm_component parent = null);\\r\\n    super.new(name, parent);\\r\\n  endfunction\\r\\n\\r\\n  virtual function void build_phase(uvm_phase phase);\\r\\n    super.build_phase(phase);\\r\\n    if (!uvm_config_db#(virtual router_if)::get(this, \\\"\\\", \\\"vif\\\", vif))\\r\\n      `uvm_fatal(\\\"NOVIF\\\", \\\"Virtual interface not found\\\")\\r\\n  endfunction\\r\\n\\r\\n  virtual task run_phase(uvm_phase phase);\\r\\n    router_transaction txn;\\r\\n    vif.resetn = 1;\\r\\n    \\/\\/wait(!vif.busy)\\r\\n    forever begin\\r\\n      \\/\\/ Drive header\\r\\n      @(negedge vif.clk);\\r\\n      seq_item_port.get_next_item(txn);\\r\\n      vif.packet_valid = 1;\\r\\n      vif.detect_add = 1;\\r\\n      vif.lfd_state = 1;\\r\\n      \\/\\/$display(\\\"addr = %0h\\\",txn.addr);\\r\\n      \\/\\/$display(\\\"len = %0h\\\",txn.payload_length);\\r\\n      txn.header = {txn.payload_length,txn.addr};\\r\\n      \\/\\/$display(\\\"header = %0b\\\",txn.header);\\r\\n      vif.datain       = txn.header;\\r\\n      \\/\\/ Drive payload\\r\\n      \\r\\n      @(negedge vif.clk);\\r\\n      vif.lfd_state = 0;\\r\\n      vif.detect_add = 0;\\r\\n      vif.ld_state = 1;\\r\\n      for (i = 0; i<txn.payload_length; i = i+ 1)\\r\\n        begin\\r\\n            \\/\\/vif.packet_valid = 1;\\r\\n          \\/\\/wait(!vif.busy)\\r\\n\\t\\t\\ttxn.payload_data={$random}%256;\\r\\n          \\t$display(\\\"data = %0b\\\",txn.payload_data);\\r\\n\\t\\t\\tvif.datain=txn.payload_data;\\t\\t\\t\\t\\t\\t\\r\\n        end\\r\\n      \\/\\/ Drive parity and deassert valid\\r\\n      \\r\\n      @(negedge vif.clk);\\r\\n      vif.packet_valid = 0;\\r\\n      vif.ld_state = 0;\\r\\n      txn.compute_parity();\\r\\n      vif.datain = txn.parity;\\r\\n \\t  \\r\\n      seq_item_port.item_done();\\r\\n      \\/\\/repeat(30);\\r\\n    end\\r\\n  endtask\\r\\nendclass\\r\\n    \\r\\n","count":8,"parent":null,"isDirectory":0}, {"name":"router_monitor.sv","id":241667879,"type":"TESTBENCH","contents":"class router_monitor extends uvm_component;\\r\\n  virtual router_if vif;\\r\\n\\r\\n  uvm_analysis_port#(router_transaction) ap;\\r\\n\\r\\n  `uvm_component_utils(router_monitor)\\r\\n\\r\\n  function new(string name, uvm_component parent);\\r\\n    super.new(name, parent);\\r\\n    ap = new(\\\"ap\\\", this);\\r\\n  endfunction\\r\\n\\r\\n  virtual function void build_phase(uvm_phase phase);\\r\\n    super.build_phase(phase);\\r\\n    if (!uvm_config_db#(virtual router_if)::get(this, \\\"\\\", \\\"vif\\\", vif))\\r\\n      `uvm_fatal(\\\"NOVIF\\\", \\\"Virtual interface not found\\\")\\r\\n  endfunction\\r\\n\\r\\n  virtual task run_phase(uvm_phase phase);\\r\\n    router_transaction txn = router_transaction::type_id::create(\\\"mon_txn\\\");\\r\\n\\r\\n\\r\\n    \\/\\/@(posedge vif.clk);\\r\\n    while (vif.packet_valid !== 1) @(posedge vif.clk); \\/\\/ wait for packet\\r\\n      \\r\\n      txn.payload_data = vif.datain;\\r\\n\\r\\n    forever begin\\r\\n      @(posedge vif.clk);\\r\\n      \\/\\/$display(\\\"M_dataout0 = %0b\\\",vif.data_out_0);\\r\\n      \\/\\/$display(\\\"M_dataout1 = %0b\\\",vif.data_out_1);\\r\\n      \\/\\/$display(\\\"M_dataout2 = %0b\\\",vif.data_out_2);\\r\\n      \\r\\n      if (vif.vldout_0 || vif.vldout_1 || vif.vldout_2) begin\\r\\n        \\/\\/ reconstruct header or payload as needed; here we only capture datain\\r\\n        txn.header        = vif.datain;  \\r\\n        txn.payload = new[0];            \\/\\/ empty, or extend if needed\\r\\n        txn.parity = 0;                  \\/\\/ unused\\r\\n        ap.write(txn);\\r\\n      end\\r\\n    end\\r\\n  endtask\\r\\nendclass\\r\\n","count":9,"parent":null,"isDirectory":0}, {"name":"router_scoreboard.sv","id":241667880,"type":"TESTBENCH","contents":"class router_scoreboard extends uvm_component;\\r\\n  uvm_analysis_imp#(router_transaction, router_scoreboard) imp;\\r\\n\\r\\n  `uvm_component_utils(router_scoreboard)\\r\\n\\r\\n  function new(string name = \\\"router_scoreboard\\\", uvm_component parent = null);\\r\\n    super.new(name, parent);\\r\\n    imp = new(\\\"imp\\\", this);\\r\\n  endfunction\\r\\n  \\r\\nfunction void build_phase(uvm_phase phase);\\r\\n    super.build_phase(phase);\\r\\n  endfunction\\r\\n  \\r\\n  virtual function void write(router_transaction t);\\r\\n    `uvm_info(\\\"SCOREBOARD\\\", $sformatf(\\\"Monitored header = %0h\\\", t.header), UVM_LOW)\\r\\n    \\r\\n  endfunction\\r\\nendclass\\r\\n","count":10,"parent":null,"isDirectory":0}, {"name":"router_agent.sv","id":241667881,"type":"TESTBENCH","contents":"class router_agent extends uvm_agent;\\r\\n\\r\\n  `uvm_component_utils(router_agent)\\r\\n\\r\\n  router_driver     drv;\\r\\n  router_monitor    mon;\\r\\n  router_sequencer  sequencer; \\/\\/ Use custom sequencer\\r\\n\\r\\n  function new(string name, uvm_component parent);\\r\\n    super.new(name, parent);\\r\\n  endfunction\\r\\n\\r\\n  function void build_phase(uvm_phase phase);\\r\\n    super.build_phase(phase);\\r\\n\\tif(get_is_active == UVM_ACTIVE) begin\\r\\n      drv       = router_driver::type_id::create(\\\"drv\\\", this);\\r\\n      sequencer = router_sequencer::type_id::create(\\\"sequencer\\\", this);\\r\\n    end\\r\\n    mon       = router_monitor::type_id::create(\\\"mon\\\", this);\\r\\n  endfunction\\r\\n\\r\\n  function void connect_phase(uvm_phase phase);\\r\\n    \\/\\/super.connect_phase(phase);\\r\\n    if(get_is_active == UVM_ACTIVE) begin \\r\\n     drv.seq_item_port.connect(sequencer.seq_item_export);\\r\\n    end\\r\\n  endfunction\\r\\n\\r\\nendclass\\r\\n","count":11,"parent":null,"isDirectory":0}, {"name":"router_env.sv","id":241667882,"type":"TESTBENCH","contents":"class router_env extends uvm_env;\\r\\n\\r\\n  `uvm_component_utils(router_env)\\r\\n\\r\\n  router_agent       agent;\\r\\n  router_scoreboard  sb;\\r\\n  \\/\\/virtual router_if  vif;\\r\\n\\r\\n  function new(string name, uvm_component parent);\\r\\n    super.new(name, parent);\\r\\n  endfunction\\r\\n\\r\\n  function void build_phase(uvm_phase phase);\\r\\n    super.build_phase(phase);\\r\\n\\r\\n    agent = router_agent::type_id::create(\\\"agent\\\", this);\\r\\n    sb    = router_scoreboard::type_id::create(\\\"sb\\\", this);\\r\\n\\r\\n    \\/\\/if (!uvm_config_db #(virtual router_if)::get(this, \\\"\\\", \\\"vif\\\", vif)) begin\\r\\n     \\/\\/ `uvm_fatal(\\\"VIF\\\", \\\"Failed to get virtual interface from config DB\\\")\\r\\n  \\/\\/  end\\r\\n  endfunction\\r\\n\\r\\n  function void connect_phase(uvm_phase phase);\\r\\n    \\/\\/super.connect_phase(phase);\\r\\n\\r\\n    agent.mon.ap.connect(sb.imp);\\r\\n    \\/\\/agent.sequencer.vif = this.vif;\\r\\n  endfunction\\r\\n\\r\\nendclass\\r\\n","count":12,"parent":null,"isDirectory":0}, {"name":"router_test.sv","id":241667883,"type":"TESTBENCH","contents":"`include \\\"router_transaction.sv\\\"\\r\\n`include \\\"router_sequence.sv\\\"\\r\\n`include \\\"router_sequencer.sv\\\"\\r\\n`include \\\"router_driver.sv\\\"\\r\\n`include \\\"router_monitor.sv\\\"\\r\\n`include \\\"router_scoreboard.sv\\\"\\r\\n`include \\\"router_agent.sv\\\"\\r\\n`include \\\"router_env.sv\\\"\\r\\n\\r\\nclass router_test extends uvm_test;\\r\\n  \\r\\n  router_env       env;\\r\\n  router_sequence  seq;\\r\\n  \\r\\n  `uvm_component_utils(router_test)\\r\\n  \\r\\n  function new(string name, uvm_component parent);\\r\\n    super.new(name, parent);\\r\\n  endfunction\\r\\n\\r\\n  virtual function void build_phase(uvm_phase phase);\\r\\n    $display(\\\"entering build phase\\\");\\r\\n    super.build_phase(phase);\\r\\n    env = router_env::type_id::create(\\\"env\\\", this);\\r\\n  endfunction\\r\\n\\r\\n  virtual task run_phase(uvm_phase phase);\\r\\n    $display(\\\"entering run phase 1\\\");\\r\\n    phase.raise_objection(this);\\r\\n    seq = router_sequence::type_id::create(\\\"seq\\\");\\r\\n    \\/\\/seq.vif = env.agent.sequencer.vif;\\r\\n    \\/\\/seq.start(env.agent.sequencer);\\r\\n    $display(\\\"entering run phase 2\\\");\\r\\n    repeat(10) begin \\r\\n      #5; seq.start(env.agent.sequencer);\\r\\n    end\\r\\n    $display(\\\"entering run phase 3\\\");\\r\\n    #1000ns;\\r\\n    phase.drop_objection(this);\\r\\n    $display(\\\"entering run phase 4\\\");\\r\\n    `uvm_info(get_type_name, \\\"End of testcase\\\", UVM_LOW);\\r\\n    $finish;\\r\\n  endtask\\r\\nendclass\\r\\n","count":13,"parent":null,"isDirectory":0}];
    </script>
